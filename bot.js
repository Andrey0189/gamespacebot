...
client.on("message", async message => {
    ...
    add_command(['omegalul', 'lul', 'omegalol', 'lol', 'лол', 'лул', 'омегалул', 'омегалол'], false, message, command, args, 'e', null, function () {
        message.channel.send(`${client.emojis.get('449216330818912267')}${client.emojis.get('449216330818912267')}${client.emojis.get('449216330818912267')}${client.emojis.get('449216330818912267')}${client.emojis.get('449216330818912267')}${client.emojis.get('449216330818912267')}`).then(msg => {
            msg.react(client.emojis.get('449216330818912267')).catch();
            msg.react(client.emojis.get('439411257099943946')).catch();
            msg.react(client.emojis.get('439411283402424322')).catch();
            msg.react(client.emojis.get('439411860954021900')).catch();
            msg.react(client.emojis.get('439411897146671105')).catch();
            msg.react(client.emojis.get('439411919582003211')).catch();
        })
    }, 'hid');
